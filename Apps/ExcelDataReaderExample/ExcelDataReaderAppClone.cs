...
// [App(icon: Icons.Sheet, title: "Excel Data Reader Clone", path: ["Pages"])]
public class ExcelDataReaderSheetClone(Action onClose) : ViewBase
{
  ...
  public override object? Build()
  {
    ...
    return new Sheet(
        ...
        "Excel Import (Clone)",
        "Duplicated sheet for testing file imports."
    );
  }
