...
| new DailyRevenueTrendLineChartView(fromDate, toDate).Key(fromDate, toDate)| new RevenueBySourcePieChartView(fromDate, toDate).Key(fromDate, toDate)| new TopPerformingTracksLineChartView(fromDate, toDate).Key(fromDate, toDate)| new ArtistRevenueComparisonLineChartView(fromDate, toDate).Key(fromDate, toDate)| new AlbumRevenueDistributionPieChartView(fromDate, toDate).Key(fromDate, toDate)| new CampaignRevenueImpactLineChartView(fromDate, toDate).Key(fromDate, toDate)            ;
