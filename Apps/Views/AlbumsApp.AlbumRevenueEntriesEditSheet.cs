...
public class AlbumRevenueEntriesEditSheet(IState<bool> isOpen, RefreshToken refreshToken, int id) : ViewBase
{
    public override object? Build()
    {
        var factory = UseService<ArtistInsightToolContextFactory>();
        var revenueEntry = UseState(() => factory.CreateDbContext().RevenueEntries.FirstOrDefault(e => e.Id == id)!);
