...
public class TrackRevenueEntriesCreateDialog(IState<bool> isOpen, RefreshToken refreshToken, int? trackId) : ViewBase
{
    ...
    public override object? Build()
    {
        ...
        UseEffect(() =>
        {
            if (trackId.HasValue)
            {
                var entryId = CreateRevenueEntry(factory, revenueEntry.Value, trackId.Value);
    ...
    private int CreateRevenueEntry(ArtistInsightToolContextFactory factory, RevenueEntryCreateRequest request, int trackId)
    {
