...
public class CampaignRevenueEntriesEditSheet(IState<bool> isOpen, RefreshToken refreshToken, int revenueEntryId) : ViewBase
{
    public override object? Build()
    {
        ...
        return revenueEntry
            ...
            .Builder(e => e.SourceId, e => e.ToAsyncSelectInput(QueryRevenueSources(factory), LookupRevenueSource(factory), placeholder: "Select Revenue Source"))
    ...
    private static AsyncSelectQueryDelegate<int?> QueryRevenueSources(ArtistInsightToolContextFactory factory)
    {
        return async query =>
        {
    ...
    private static AsyncSelectLookupDelegate<int?> LookupRevenueSource(ArtistInsightToolContextFactory factory)
    {
        return async id =>
        {
