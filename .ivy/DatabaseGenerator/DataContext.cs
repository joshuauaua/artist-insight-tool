...
public class RevenueSource
{
  ...
  public static RevenueSource[] GetSeedData()
  {
    ...
    {
            new RevenueSource { Id = 1, DescriptionText = "Merch" },
            new RevenueSource { Id = 2, DescriptionText = "Live Show" },
            new RevenueSource { Id = 3, DescriptionText = "Sync" },
            new RevenueSource { Id = 4, DescriptionText = "Streams" },
